...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#25D366]/90 hover:bg-[#25D366] backdrop-blur-xs shadow-[0_4px_16px_rgba(37,211,102,0.25)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.4)] hover:scale-105 transition-all duration-300">
        <svg
          viewBox="0 0 32 32"
      ...
      <span className="hidden sm:block absolute right-full top-1/2 -translate-y-1/2 mr-3 whitespace-nowrap bg-noir/90 backdrop-blur-xs border border-white/10 text-white text-xs px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl">
